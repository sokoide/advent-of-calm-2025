...
// ToD2 generates D2 diagram source from the architecture
func (a *Architecture) ToD2() string {
...
func writeNode(sb *strings.Builder, node *Node, indent string) {
...
func (a *Architecture) WriteD2(filename string) error {
	d2Source := a.ToD2()
