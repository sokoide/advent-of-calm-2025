...
// ToRichD2 generates D2 diagram source with embedded CALM metadata.
// The metadata is stored in comments with @calm: prefix for bidirectional editing.
func (a *Architecture) ToRichD2() string {
...
func writeRichNode(sb *strings.Builder, node *Node, indent string) {
...
func writeRichContainerNode(sb *strings.Builder, container *Node, childIDs []string, allNodes []*Node) {
