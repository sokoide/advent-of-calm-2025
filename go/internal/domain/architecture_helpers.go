...
// WithCostCenter sets the cost center for the node.
func WithCostCenter(costCenter string) NodeOption {
	return func(n *Node) {
		n.CostCenter = costCenter
	}
}
...
// WithInterfaces appends interfaces to the node.
func WithInterfaces(interfaces ...*Interface) NodeOption {
	return func(n *Node) {
