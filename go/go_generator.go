...
// GenerateGoDSL generates Go DSL code from a CALM Architecture.
// This enables the D2 → Go direction of bidirectional editing.
func (a *Architecture) GenerateGoDSL() string {
...
func generateNodeDSL(sb *strings.Builder, node *Node) {
...
func generateInterfaceDSL(sb *strings.Builder, iface Interface) {
...
func generateRelDSL(sb *strings.Builder, rel *Relationship) {
...
func generateFlowDSL(sb *strings.Builder, flow *Flow) {
...
func generateControlDSL(sb *strings.Builder, id string, ctrl *Control) {
